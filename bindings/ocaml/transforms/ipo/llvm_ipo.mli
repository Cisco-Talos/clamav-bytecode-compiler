...
external add_dead_type_elimination :
  [ | `Module ] Llvm.PassManager.t -> unit = "llvm_add_dead_type_elimination"
...
external add_lower_set_jmp : [ | `Module ] Llvm.PassManager.t -> unit =
  "llvm_add_lower_set_jmp"
