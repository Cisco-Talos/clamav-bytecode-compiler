...
\paragraph[{pdf\_\-flag}]{\setlength{\rightskip}{0pt plus 5cm}enum {\bf pdf\_\-flag}}\hfill}
...
\paragraph[{pdf\_\-objflags}]{\setlength{\rightskip}{0pt plus 5cm}enum {\bf pdf\_\-objflags}}\hfill}
...
\paragraph[{pdf\_\-phase}]{\setlength{\rightskip}{0pt plus 5cm}enum {\bf pdf\_\-phase}}\hfill}
...
\begin{DoxyParams}{Parameters}
\item[{\em a}]-\/ os\_\-category $<$$<$ 24 $|$ arch $<$$<$ 20 $|$ compiler $<$$<$ 16 $|$ flevel $<$$<$ 8 $|$ dconf \item[{\em b}]-\/ big\_\-endian $<$$<$ 28 $|$ sizeof\_\-ptr $<$$<$ 24 $|$ cpp\_\-version \item[{\em c}]-\/ os\_\-features $<$$<$ 24 $|$ c\_\-version \end{DoxyParams}
\begin{DoxyReturn}{Returns}
0 -\/ no match 1 -\/ match 
\end{DoxyReturn}
\begin{Desc}
...
\begin{DoxyParams}{Parameters}
\item[\mbox{\tt[in]} {\em str}]Message to print \item[\mbox{\tt[in]} {\em len}]length of message to print \end{DoxyParams}
\begin{DoxyReturn}{Returns}
0 
\end{DoxyReturn}
\begin{Desc}
...
\begin{DoxyParams}{Parameters}
\item[\mbox{\tt[in]} {\em a}]number to print \end{DoxyParams}
\begin{DoxyReturn}{Returns}
0 
\end{DoxyReturn}
\begin{Desc}
...
\begin{DoxyParams}{Parameters}
\item[{\em reason}]-\/ why the bytecode had to be disabled \item[{\em len}]-\/ length of reason \item[{\em cond}]-\/ condition \end{DoxyParams}
\begin{DoxyReturn}{Returns}
...
\begin{DoxyParams}{Parameters}
\item[{\em reason}]-\/ why the JIT had to be disabled \item[{\em len}]-\/ length of reason \item[{\em cond}]-\/ condition \end{DoxyParams}
\begin{DoxyReturn}{Returns}
0 -\/ auto mode 1 -\/ JIT disabled 2 -\/ fully disabled 
\end{DoxyReturn}
\begin{Desc}
...
\begin{DoxyParams}{Parameters}
\item[\mbox{\tt[out]} {\em result}]pointer to struct holding result \item[\mbox{\tt[in]} {\em len}]how many bytes to disassemble \end{DoxyParams}
\begin{DoxyReturn}{Returns}
0 for success
\end{DoxyReturn}
...
\begin{DoxyParams}{Parameters}
\item[\mbox{\tt[in]} {\em id}]an id for the new file (for example position in container) \end{DoxyParams}
\begin{DoxyReturn}{Returns}
...
\begin{DoxyParams}{Parameters}
\item[\mbox{\tt[in]} {\em data}]the sequence of bytes to look for \item[{\em len}]length of {\ttfamily data}, cannot be more than 1024 \end{DoxyParams}
\begin{DoxyReturn}{Returns}
...
\begin{DoxyParams}{Parameters}
\item[\mbox{\tt[in]} {\em data}]the sequence of bytes to look for \item[{\em len}]length of {\ttfamily data}, cannot be more than 1024 \item[{\em maxpos}]maximum position to look for a match, note that this is 1 byte after the end of last possible match: match\_\-pos + {\ttfamily len} $<$ {\ttfamily maxpos} \end{DoxyParams}
\begin{DoxyReturn}{Returns}
offset in the current file if match is found, -\/1 otherwise 
\end{DoxyReturn}
\begin{Desc}
...
\begin{DoxyParams}{Parameters}
\item[\mbox{\tt[out]} {\em buffer}]the buffer to fill \item[\mbox{\tt[in]} {\em len}]length of buffer \item[\mbox{\tt[in]} {\em filled}]how much of the buffer is currently filled \item[\mbox{\tt[in]} {\em cursor}]position of cursor in buffer \item[\mbox{\tt[in]} {\em fill}]amount of bytes to fill in (0 is valid) \end{DoxyParams}
\begin{DoxyReturn}{Returns}
...
\begin{DoxyParams}{Parameters}
\item[\mbox{\tt[out]} {\em env}]-\/ the full environment \item[{\em len}]-\/ size of {\ttfamily env} \end{DoxyParams}
\begin{DoxyReturn}{Returns}
0 
\end{DoxyReturn}
\begin{Desc}
...
\begin{DoxyParams}{Parameters}
\item[\mbox{\tt[out]} {\em section}]PE section information will be stored here \item[\mbox{\tt[in]} {\em num}]PE section number \end{DoxyParams}
\begin{DoxyReturn}{Returns}
0 -\/ success -\/1 -\/ failure 
\end{DoxyReturn}
...
\begin{DoxyParams}{Parameters}
\item[\mbox{\tt[in]} {\em group1}]-\/ same as GROUP1 in LDB signatures \item[{\em group1\_\-len}]-\/ length of {\ttfamily group1} \item[\mbox{\tt[in]} {\em group2}]-\/ same as GROUP2 in LDB signatures \item[{\em group2\_\-len}]-\/ length of {\ttfamily group2} \end{DoxyParams}
\begin{DoxyReturn}{Returns}
...
\begin{DoxyParams}{Parameters}
\item[{\em objidx}]-\/ object index (from 0), not object id! \item[{\em amount}]-\/ size returned by pdf\_\-getobjsize (or smaller) \end{DoxyParams}
\begin{DoxyReturn}{Returns}
...
\begin{DoxyParams}{Parameters}
\item[{\em objidx}]-\/ object index (from 0), not object id! \end{DoxyParams}
\begin{DoxyReturn}{Returns}
...
\begin{DoxyParams}{Parameters}
\item[{\em id}]-\/ pdf id (objnumber $<$$<$ 8 $|$ generationid) \end{DoxyParams}
\begin{DoxyReturn}{Returns}
...
\begin{DoxyParams}{Parameters}
\item[{\em flags}]-\/ flags to set. \end{DoxyParams}
\begin{DoxyReturn}{Returns}
...
\begin{DoxyParams}{Parameters}
\item[\mbox{\tt[in]} {\em size}]amount of bytes to read \item[\mbox{\tt[out]} {\em data}]pointer to buffer where data is read into \end{DoxyParams}
\begin{DoxyReturn}{Returns}
amount read. 
\end{DoxyReturn}
\begin{Desc}
...
\begin{DoxyParams}{Parameters}
\item[\mbox{\tt[in]} {\em radix}]10 or 16 \end{DoxyParams}
\begin{DoxyReturn}{Returns}
the number read 
\end{DoxyReturn}
...
\begin{DoxyParams}{Parameters}
\item[\mbox{\tt[in]} {\em pos}]offset (absolute or relative depending on {\ttfamily whence} param) \item[\mbox{\tt[in]} {\em whence}]one of {\ttfamily SEEK\_\-SET}, {\ttfamily SEEK\_\-CUR}, {\ttfamily SEEK\_\-END} \end{DoxyParams}
\begin{DoxyReturn}{Returns}
...
\begin{DoxyParams}{Parameters}
\item[\mbox{\tt[in]} {\em name}]the name of the virus \item[\mbox{\tt[in]} {\em len}]length of the virusname \end{DoxyParams}
\begin{DoxyReturn}{Returns}
0 
\end{DoxyReturn}
\begin{Desc}
...
\begin{DoxyParams}{Parameters}
\item[\mbox{\tt[in]} {\em lhs}]-\/ left hand side of comparison \item[{\em lhs\_\-len}]-\/ length of {\ttfamily lhs} \item[\mbox{\tt[in]} {\em rhs}]-\/ right hand side of comparison \item[{\em rhs\_\-len}]-\/ length of {\ttfamily rhs} \end{DoxyParams}
\begin{DoxyReturn}{Returns}
...
\begin{DoxyParams}{Parameters}
\item[\mbox{\tt[in]} {\em data}]pointer to buffer of data to write \item[\mbox{\tt[in]} {\em size}]amount of bytes to write {\ttfamily size} bytes to temporary file, from the buffer pointed to byte \end{DoxyParams}
\begin{DoxyReturn}{Returns}
...
\paragraph[{\_\-\_\-clambc\_\-match\_\-offsets}]{\setlength{\rightskip}{0pt plus 5cm}const uint32\_\-t {\bf \_\-\_\-clambc\_\-match\_\-offsets}\mbox{[}64\mbox{]}}\hfill}
